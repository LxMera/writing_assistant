...
class OpenAIService:
    ...
    async def rephrase_text(self, text: str) -> Dict[str, str]:
        """Rephrase text in all styles at once"""
        prompt = f"""
        Please rephrase the following text in these 4 different writing styles, using the same language as the input text.  
    ...
    async def rephrase_text_stream(self, text: str) -> AsyncGenerator[Dict[str, str], None]:
